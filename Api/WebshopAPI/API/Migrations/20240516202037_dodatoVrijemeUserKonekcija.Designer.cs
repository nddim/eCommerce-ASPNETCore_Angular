...
namespace WebAPI.Migrations
{
    ...
    [Migration("20240516202037_dodatoVrijemeUserKonekcija")]
    partial class dodatoVrijemeUserKonekcija
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPI.Data.Models.ProizvodKlik", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPI.Data.Models.RacunAktivacija", b =>
                {
                    ...
                    b.Property<DateTime>("DatumValidnost")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("WebAPI.Data.Models.UserKonekcija", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserKonekcija");
                });

            modelBuilder.Entity("WebAPI.Data.Models.Vijest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPI.Endpoints.AuthEndpoints.MicrosoftIdentity.Models.Otp2fa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPI.Endpoints.AuthEndpoints.MicrosoftIdentity.Models.Otp2fa", b =>
                {
                    b.HasOne("WebAPI.Endpoints.AuthEndpoints.MicrosoftIdentity.Models.Korisnik", "Korisnk")
                        .WithMany()
                        .HasForeignKey("KorisnikId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Korisnk");
                });
